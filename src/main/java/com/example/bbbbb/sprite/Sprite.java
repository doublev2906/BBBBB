...
public class Sprite {
	...
	public static Sprite font_explosion_1 = new Sprite(DEFAULT_SIZE,2, 2, SpriteSheet.flames,16,16);
	public static Sprite font_explosion_2= new Sprite(DEFAULT_SIZE,7, 2, SpriteSheet.flames,16,16);
	public static Sprite font_explosion_3 = new Sprite(DEFAULT_SIZE,2, 7, SpriteSheet.flames,16,16);
	public static Sprite font_explosion_4 = new Sprite(DEFAULT_SIZE,7, 7, SpriteSheet.flames,16,16);

	public static Sprite right_explosion_1 = new Sprite(DEFAULT_SIZE,4, 2, SpriteSheet.flames,16,16);
	public static Sprite right_explosion_2= new Sprite(DEFAULT_SIZE,9, 2, SpriteSheet.flames,16,16);
	public static Sprite right_explosion_3 = new Sprite(DEFAULT_SIZE,4, 7, SpriteSheet.flames,16,16);
	public static Sprite right_explosion_4 = new Sprite(DEFAULT_SIZE,9, 7, SpriteSheet.flames,16,16);

	public static Sprite left_explosion_1 = new Sprite(DEFAULT_SIZE,0, 2, SpriteSheet.flames,16,16);
	public static Sprite left_explosion_2= new Sprite(DEFAULT_SIZE,5, 2, SpriteSheet.flames,16,16);
	public static Sprite left_explosion_3 = new Sprite(DEFAULT_SIZE,0, 7, SpriteSheet.flames,16,16);
	public static Sprite left_explosion_4 = new Sprite(DEFAULT_SIZE,5, 7, SpriteSheet.flames,16,16);

	public static Sprite up_explosion_1 = new Sprite(DEFAULT_SIZE,2, 0, SpriteSheet.flames,16,16);
	public static Sprite up_explosion_2= new Sprite(DEFAULT_SIZE,7, 0, SpriteSheet.flames,16,16);
	public static Sprite up_explosion_3 = new Sprite(DEFAULT_SIZE,2, 5, SpriteSheet.flames,16,16);
	public static Sprite up_explosion_4 = new Sprite(DEFAULT_SIZE,7, 5, SpriteSheet.flames,16,16);

	public static Sprite down_explosion_1 = new Sprite(DEFAULT_SIZE,2, 4, SpriteSheet.flames,16,16);
	public static Sprite down_explosion_2= new Sprite(DEFAULT_SIZE,7, 4, SpriteSheet.flames,16,16);
	public static Sprite down_explosion_3 = new Sprite(DEFAULT_SIZE,2, 9, SpriteSheet.flames,16,16);
	public static Sprite down_explosion_4 = new Sprite(DEFAULT_SIZE,7, 9, SpriteSheet.flames,16,16);

	public static Sprite right_center_explosion_1 = new Sprite(DEFAULT_SIZE,3, 2, SpriteSheet.flames,16,16);
	public static Sprite right_center_explosion_2= new Sprite(DEFAULT_SIZE,8, 2, SpriteSheet.flames,16,16);
	public static Sprite right_center_explosion_3 = new Sprite(DEFAULT_SIZE,3, 7, SpriteSheet.flames,16,16);
	public static Sprite right_center_explosion_4 = new Sprite(DEFAULT_SIZE,8, 7, SpriteSheet.flames,16,16);

	public static Sprite left_center_explosion_1 = new Sprite(DEFAULT_SIZE,1, 2, SpriteSheet.flames,16,16);
	public static Sprite left_center_explosion_2= new Sprite(DEFAULT_SIZE,6, 2, SpriteSheet.flames,16,16);
	public static Sprite left_center_explosion_3 = new Sprite(DEFAULT_SIZE,1, 7, SpriteSheet.flames,16,16);
	public static Sprite left_center_explosion_4 = new Sprite(DEFAULT_SIZE,6, 7, SpriteSheet.flames,16,16);

	public static Sprite up_center_explosion_1 = new Sprite(DEFAULT_SIZE,2, 1, SpriteSheet.flames,16,16);
	public static Sprite up_center_explosion_2= new Sprite(DEFAULT_SIZE,7, 1, SpriteSheet.flames,16,16);
	public static Sprite up_center_explosion_3 = new Sprite(DEFAULT_SIZE,2, 6, SpriteSheet.flames,16,16);
	public static Sprite up_center_explosion_4 = new Sprite(DEFAULT_SIZE,7, 6, SpriteSheet.flames,16,16);

	public static Sprite down_center_explosion_1 = new Sprite(DEFAULT_SIZE,2, 3, SpriteSheet.flames,16,16);
	public static Sprite down_center_explosion_2= new Sprite(DEFAULT_SIZE,7, 3, SpriteSheet.flames,16,16);
	public static Sprite down_center_explosion_3 = new Sprite(DEFAULT_SIZE,2, 8, SpriteSheet.flames,16,16);
	public static Sprite down_center_explosion_4 = new Sprite(DEFAULT_SIZE,7, 8, SpriteSheet.flames,16,16);
